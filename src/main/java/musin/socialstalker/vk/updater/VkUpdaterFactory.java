...
public class VkUpdaterFactory implements UpdaterFactory {
  ...
  private final List<UpdateNotifierFactory<VkNotifiableUpdate, VkRelationType>> notifierFactories;
  ...
  private UpdateNotifier<VkNotifiableUpdate, VkRelationType> getAdminNotifier(Stalker stalker) {
  ...
  public Updater create(Stalker stalker) {
    List<UpdateNotifier<VkNotifiableUpdate, VkRelationType>> notifiers = notifierFactories.stream()
