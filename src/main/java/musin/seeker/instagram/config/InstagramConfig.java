...
public class InstagramConfig {
    ...
    if (Objects.equals(instagramLoginResult.getStatus(), "ok")
      ...
      if (Objects.equals(instagramLoginResult.getError_type(), "checkpoint_challenge_required")) {
        ...
        if (doReAuthentication) {
          ...
          String VC = new Scanner(System.in).next();
          InstagramLoginResult twoFactorInstagramLoginResult = instagram4j.login(VC);
  ...
  @Bean
  @SneakyThrows
  public Instagram4j instagram(InstagramConfigurationProperties config) {
